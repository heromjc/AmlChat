...
import com.amlogic.avpipe.AVTypes.EncoderOptimizations;
...
*/
    ...
    private void initEncodeMediaCodec() {
        try {
            ...
            /*set framerate*/
            if (mEncoderOptimizations.encoder_framerate_value != 0) {
            ...
            if (mEncoderOptimizations.encoder_bitrate_enable && mEncoderOptimizations.encoder_bitrate_value != 0) {
                Log.e(TAG, "Set Bitrate as " + (mEncoderOptimizations.encoder_bitrate_value*1000));
